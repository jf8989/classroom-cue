...
All cues use real, bundled CC0 recordings that play directly in the active tab. They are normalized to **−14 dBFS C-weighted RMS** and limited to **−1 dB true peak**. When you share that same tab in Google Meet with **Share tab audio** enabled, your students hear the cues. The extension has no trackers or network requests. See [sound credits](CREDITS.md) for the complete source and license record.
